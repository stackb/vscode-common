...
describe('Arrays', () => {
	...
	it('topAsync', async () => {
		...
		await itTopAsync(cmp, 1);
		return itTopAsync(cmp, 2);
	});

	async function itTopAsync(cmp: any, m: number) {
		{
