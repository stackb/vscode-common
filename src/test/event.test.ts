...
import { AsyncEmitter, Emitter, Event, EventBufferer, EventMultiplexer, IWaitUntil, PauseableEmitter } from '../event';
...
describe('Event', function () {
	...
	// NOTE: removed as document is not in scope
	...
	it('Debounce Event', function (done: () => void) {
		let doc = new Samples.Document3();
	...
	it('Debounce Event - leading', async function () {
	...
	it('Debounce Event - leading reset', async function () {
...
describe('Event utils', () => {
	...
	describe('fromPromise', () => {
		...
		it('should emit when done', async () => {
			let count = 0;
		...
		it('should emit when done - setTimeout', async () => {
			let count = 0;
